...
# [교육 내용](https://velog.io/@bbalgang/series/기록-Public-Data)

 | **파일** | **날짜** | **내용** | **velog**|
 |:-----:|:-----:|:-----:|:------:|
 |240124| 24. 1. 24. | 대구 기온데이터, matplotlib | [velog link]( https://velog.io/@bbalgang/124-Public-Data-1일차-120123-포함 ) |
 |240125| 24. 1. 25. | 서울 지하철 데이터 | [velog link]( https://velog.io/@bbalgang/125-공공데이터-2일차 ) |
 |240126| 24. 1. 26. | 대구 인구 수 데이터, 전국 인구 데이터  | [velog link]( https://velog.io/@bbalgang/126-공공데이터-3일차 ) |
 |240129| 24. 1. 29. | 공공보건의료기관 데이터 | [velog link]( https://velog.io/@bbalgang/119-공공데이터-4일차 ) |
